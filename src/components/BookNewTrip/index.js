...
class BookNewTrip extends Component {
  state = {
    ...
    childrensCount: 0,
    infantsCount: 0,
    isTravelAssistanceCheckboxChecked: false,
        ...
        {value => {
          ...
          const onClickPreviousInDateSelection = () => {
            this.setState(prevState => ({
              ...
              isCompletedStepList: prevState.isCompletedStepList.filter(
                eachCompletedList => eachCompletedList !== stepsList[0].stepId,
              ),
            }))
          }
          ...
          const onClickPreviousInGuestForm = () => {
            this.setState(prevState => ({
              onSelectedStep: stepsList[1].stepId,
              isCompletedStepList: prevState.isCompletedStepList.filter(
                eachCompletedList => eachCompletedList !== stepsList[1].stepId,
              ),
            }))
          }
          ...
          const onChangeTravelAssistanceCheckbox = () => {
            this.setState(prevState => ({
              isTravelAssistanceCheckboxChecked: !prevState.isTravelAssistanceCheckboxChecked,
            }))
          }
          ...
          const onClickPreviousInTravelAssistance = () => {
            this.setState(prevState => ({
              onSelectedStep: stepsList[2].stepId,
              isCompletedStepList: prevState.isCompletedStepList.filter(
                eachCompletedList => eachCompletedList !== stepsList[2].stepId,
              ),
            }))
          }
          ...
          const onClickConfirmBookingBtn = () => {
            ...
            const tripsDetails = {
              ...
              startLocation: yourDetailsStartLocation,
              ...
              travelAssistance: selectedTripValue,
            }
          ...
          const renderTravelAssistanceForm = () => {
            const {
              isTravelAssistanceCheckboxChecked,
              selectedTripValue,
            } = this.state
                ...
                <div className="your-details-form-container">
                  <div className="checkbox-container">
                    <input
                      ...
                      checked={isTravelAssistanceCheckboxChecked}
